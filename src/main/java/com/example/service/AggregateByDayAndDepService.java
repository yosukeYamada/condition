...
@Service
@Transactional
public class AggregateByDayAndDepService {

	@Autowired
	private UserMapper userMapper;
	
	/**
	 * 引数で受け取った日付、部署名での投稿の集計を行うメソッド.
	 * 
	 * @param date 日付
	 * @param depId 部署ID
	 * @return 集計結果
	 */
	public Map<String, DailyScore> aggregateByDateAndDep(String date, Integer depId) {
        ...
        List<User> employeeListByDayAndDep = userMapper.findByDayAndDep(startTs, endTs, depId);
        ...
        for(User user : employeeListByDayAndDep) {

...
/**
 * 月別で投稿内容の集計を行うサービスクラス
 * 
 * @author yuichiyasui
 */
@Service
@Transactional
public class AggregateByMonthService {
     ...
     * @return 集計結果
     */
    public Map<String, Map<String, DailyScore>> aggregateByMonth(String date) {
        ...
        List<DailyPost> monthPostList = dailyPostMapper.findByDate(startTs, endTs);
        ...
        for (DailyPost post : monthPostList) {
